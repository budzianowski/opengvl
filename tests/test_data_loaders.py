...
class TestBaseDataLoader:
    ...
    def test_initialization_custom_params(self):
        ...
        loader = MockDataLoader(num_frames=5, num_context_episodes=2, shuffle=True, seed=123)
...
class TestDataLoaderIntegration:
    ...
    def test_concrete_loader_implementation_pattern(self):
        ...
        loader = ConcreteDataLoader(dataset_size=5, num_frames=3, num_context_episodes=1, shuffle=True, seed=42)
