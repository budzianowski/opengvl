...
class TestAliases:
    ...
    def test_event_type_aliases(self):
        ...
        from opengvl.utils.aliases import Event, TextEvent, ImageEvent
...
class TestUtilityFunctions:
    ...
    def test_metric_computation_patterns(self):
        ...
        from opengvl.utils.data_types import InferredFewShotResult, InferredEpisode
...
class TestIntegrationPatterns:
    ...
    def test_serialization_roundtrip(self):
        ...
        from opengvl.results.prediction import PredictionRecord, DatasetMetrics
        from opengvl.utils.data_types import InferredFewShotResult, InferredEpisode
